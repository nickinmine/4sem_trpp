...
INSERT INTO `account` (`idclient`,`accountnum`,`currency`,`descript`,`closed`,`type`,`default`) VALUES 
 ...
 (15,'42301810100010000002','810','Основной счет вклада','0000-00-00','active',0),
 (15,'42301810100010000003','810','Основной счет вклада','0000-00-00','active',0),
 (15,'47411810100010000004','810','Дополнительный счет вклада','0000-00-00','active',0),
 (15,'47411810100010000005','810','Дополнительный счет вклада','0000-00-00','active',0),
...
CREATE TABLE `capterms` (
  ...
  `modify` varchar(45) DEFAULT NULL,
...
INSERT INTO `capterms` (`cap`,`modify`,`descript`) VALUES 
 ('dayend','+1 day','В конце дня'),
 ('depositend',NULL,'В конце срока'),
 ('month3end','+3 month','В конце каждого третьего месяца'),
 ('monthend','+1 month','В конце каждого месяца');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Вклады';
...
INSERT INTO `deposits` (`id`,`idclient`,`type`,`opendate`,`closedate`,`mainacc`,`percacc`,`update`) VALUES 
 (3,15,'ben1y','2022-03-25','0000-00-00','42301810100010000002','47411810100010000004','2022-03-25'),
 (4,15,'save1y','2022-03-25','0000-00-00','42301810100010000003','47411810100010000005','2022-03-25');
...
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Таблица операций';
...
INSERT INTO `operations` (`idoper`,`db`,`cr`,`operdate`,`sum`,`employee`) VALUES 
 ...
 (132,'40800810100010000023','42301810100010000002','2022-03-25 12:12:40','100000.00','admin'),
 (133,'20202810100000000001','40800810100010000023','2022-03-25 13:55:10','100000.00','admin'),
 (134,'40800810100010000023','42301810100010000003','2022-03-25 13:55:22','100000.00','admin');
